...
// TCP only send data as byte, to know exaclty what sender sent to receiver we need some format called
// TLV : type + lenght + value. Also we need  decoder in receiver and encoder in sender
